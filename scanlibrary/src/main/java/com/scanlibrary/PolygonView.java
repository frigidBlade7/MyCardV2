...
public class PolygonView extends FrameLayout {
    ...
    private void init() {
        polygonView = this;
        pointer1 = getImageView(0, 0,1);
        pointer2 = getImageView(getWidth(), 0,2);
        pointer3 = getImageView(0, getHeight(),3);
        pointer4 = getImageView(getWidth(), getHeight(),4);
        midPointer13 = getImageView(0, getHeight() / 2,5);
        midPointer13.setOnTouchListener(new MidPointTouchListenerImpl(pointer1, pointer3));

        midPointer12 = getImageView(0, getWidth() / 2,6);
        midPointer12.setOnTouchListener(new MidPointTouchListenerImpl(pointer1, pointer2));

        midPointer34 = getImageView(0, getHeight() / 2,7);
        midPointer34.setOnTouchListener(new MidPointTouchListenerImpl(pointer3, pointer4));

        midPointer24 = getImageView(0, getHeight() / 2,8);
    ...
    private ImageView getImageView(int x, int y, int pos) {
        ImageView imageView = new ImageView(context);
        LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        imageView.setLayoutParams(layoutParams);
        switch (pos){
            case 1:
                imageView.setImageResource(R.drawable.top_left_viewfinder);
                break;
            case 2:
                imageView.setImageResource(R.drawable.top_right_viewfinder);
                break;
            case 3:
                imageView.setImageResource(R.drawable.bottom_left_viewfinder);
                break;
            case 4:
                imageView.setImageResource(R.drawable.bottom_right_viewfinder);
                break;
            case 5:
                imageView.setImageResource(R.drawable.vertical_viewfinder);
                break;
            case 6:
                imageView.setImageResource(R.drawable.horizontal_viewfinder);
                break;
            case 7:
                imageView.setImageResource(R.drawable.horizontal_viewfinder);
                break;
