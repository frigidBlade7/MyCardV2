...
@AndroidEntryPoint
class AddPersonalCardOptionsFragment : BottomSheetDialogFragment() {

    private lateinit var binding: FragmentAddCardOptionsBinding
    ...
    override fun onCreateView(
        ...
        binding.scanCard.setOnClickListener {
            dismiss()
            viewmodel.goToScanCard(Utils.SCAN_TYPE_LIVE)
        }

        binding.enterManually.setOnClickListener {
            dismiss()
            viewmodel.goToAddPersonalCard()
        }
